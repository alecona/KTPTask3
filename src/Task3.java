...
public class Task3 {
    ...
    /** Метод поиска количества корней в квадратном уравнении **/
    ...
    /** Метод поиска второго вхождения "zip" в строке **/
    ...
    /** Метод проверки, совершенное ли число **/
    ...
    /** Метод замены первого и последнего символа в строке **/
    ...
    /** Метод проверки строки на шестнадцатеричный код **/
    ...
    /** Метод проверки массивов на уникальные элементы **/
    ...
    /** Проверка, является ли данное число числом Капрекара **/
    ...
    /** Метод возвращает самую длинную последовательность последовательных нулей в двоичной строке. **/
    ...
    /** Метод возвращает следующее простое число, если исходное число не простое **/
    ...
    /** Метод проверки, является ли треугольник со сторонами x, y и z прямоугольным **/
